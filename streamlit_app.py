...
st.markdown("<h5 style='text-align: center;'>بعد تفكير طويل، قرر أن يستبعد فكرة شراء الأرض والبناء بنفسه. وبدلاً من ذلك، بدأ يفكر في شراء فيلا جاهزة. بحث كثيراً، قرر ان تكون الفلة في شرق الرياض، لقربها من عمله، وتحتوي على ثلاث غرف نوم تليق بعائلته. لكن للأسف، وجد أن أسعار الفلل في تلك المنطقة كانت تتجاوز قدراته المالية. </h5>", unsafe_allow_html=True)
